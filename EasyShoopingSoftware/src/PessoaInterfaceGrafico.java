...
public class PessoaInterfaceGrafico extends JFrame implements ActionListener {
	...
	JLabel rotuloMensagem2 		= new JLabel("Digite e escolha sua opção");
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getSource() == botaoIncluir) {
			...
			rotuloMensagem2.setText("Botão CONSULTAR Pressionado"); 
			
		} else if (evento.getSource() == botaoAlterar) {
			rotuloMensagem2.setText("Botão ALTERAR Pressionado");
			
		} else if (evento.getSource() == botaoExcluir) {
			rotuloMensagem2.setText("Botão EXCLUIR Pressionado");
